...
"""
struct OptionallyStaticUnitRange{F<:Union{Int,StaticInt},L<:Union{Int,StaticInt}} <: AbstractUnitRange{Int}
    start::F
    stop::L

    function OptionallyStaticUnitRange(start::Union{Int,StaticInt}, stop::Union{Int,StaticInt})
...
```
"""
struct OptionallyStaticStepRange{F<:Union{Int,StaticInt},S<:Union{Int,StaticInt},L<:Union{Int,StaticInt}} <: OrdinalRange{Int,Int}
    start::F
    step::S
    stop::L

    global function _OptionallyStaticStepRange(
        @nospecialize(start::Union{Int,StaticInt}),
...
function Base.axes1(x::OptionallyStaticStepRange{StaticInt{F},StaticInt{S},StaticInt{L}}) where {F,S,L}
